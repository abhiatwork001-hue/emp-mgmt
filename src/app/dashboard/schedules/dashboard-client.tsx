...
export default function ScheduleDashboardClient() {
    ...
    const formatStatus = (status: string) => {
        if (status === 'review') return 'Pending Approval';
    ...
    const filteredStores = data?.stores?.map((store: any) => {
        ...
        const filteredDepts = store.departments.filter((dept: any) => {
            ...
            return dept.schedule?.status === statusFilter;
        });
    ...
    const { summary } = data || { summary: { total: 0, inProgress: 0, pending: 0, approved: 0 } };
                    ...
                    <div className="w-full sm:w-[200px]">
                        ...
                        <Select value={statusFilter} onValueChange={setStatusFilter}>
                            ...
                            <SelectContent>
                                ...
                                <SelectItem value="review">Pending Approval</SelectItem>
                ...
                <Card>
                    <CardContent className="p-4 flex flex-col justify-between h-full">
                        ...
                        <div className="mt-2">
                            ...
                            <h3 className="text-2xl font-bold text-foreground">{summary.total}</h3>
                        </div>
                    </CardContent>
                </Card>
            </div>
