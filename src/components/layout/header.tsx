...
import { Bell, Monitor, Globe, User, ImagePlus, LogOut } from "lucide-react";
...
import { EditProfileDialog } from "@/components/employees/edit-profile-dialog";
                ...
                <div className="flex justify-end items-center gap-x-4">
                    ...
                    <DropdownMenu>
                        ...
                        <DropdownMenuContent className="w-64 p-2 rounded-2xl shadow-xl border-border/40" align="end" forceMount>
                            ...
                            >
                                <ImagePlus className="mr-3 h-4 w-4 text-emerald-500" />
                                <span className="font-medium text-sm">{t("profilePicture")}</span>
                            </DropdownMenuItem>
